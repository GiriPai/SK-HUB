...
<div id="content-container">
    <div id="page-head">
        ...
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <div id="page-title">
            <h1 class="page-header text-overflow">Staff Creation</h1>
        </div>
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <!--End page title-->
		...
		<li class="active">Create Staff Profile</li>
        </ol>
        <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
        <!--End breadcrumb-->
		...
		<div class="row">
		    ...
		    <div class="col-lg-12">
		        <div class="panel">
		            ...
		            <form id="demo-bvd-notempty" action="{{ route('admin-staff-management.store')}}" class="form-horizontal" method="post">
		            	@csrf
