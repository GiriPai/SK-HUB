    ...
    <div id="page-content">
		...
		<div class="panel">
		    <div class="panel-heading">
		        <h3 class="panel-title">All Students List</h3>
		    </div>
		        ...
		        <table id="demo-foo-filtering" class="table table-bordered table-hover toggle-circle" data-page-size="7">
		            ...
		            <tbody>
		                ...
		                <tr>
		                    ...
		                    <td><a href="{{route('admin_view_student',$student->id)}}">{{ $student->fname }}  {{ $student->lname }}</a></td>
		                    ...
		                    <td><center>
			                    <div class="btn-group">
			                        <a href="{{ route('admin-student-management.show',$student->id) }}"><button class="btn btn-default"><i class="demo-pli-exclamation"></i></button></a>
