        ...
        <div class="row">
          <div class="col-lg-12">
              <div class="panel">
                  ...
                  <!-- BASIC FORM ELEMENTS -->
                  <!--===================================================-->
                  <form class="panel-body form-horizontal form-padding"  method="post" action="{{route('staffprofile.update','staff')}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                      <!--Static-->
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-9"><p class="form-control-static">{{$u->department->department_full_name}}</p></div>
                      </div>
                      @if(count($u->course) == 1)
                      <div class="form-group">
                          <label class="col-md-3 control-label">Course</label>
                          <div class="col-md-9"><p class="form-control-static">@foreach($u->course as $v){{$v->course_name}}@endforeach</p></div>
                      </div>
                      @endif
                      <div class="form-group">
                      ...
                      <!--Textarea-->
                      <div class="form-group">
                          <label class="col-md-3 control-label" for="demo-text-input">Degree </label>
                          <div class="col-md-9">
                              <input type="text" id="demo-text-input" class="form-control" placeholder="{{$u->degree}}" value="{{$u->degree}}" name="degree">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-md-9">
                              <input type="text" id="demo-text-input" class="form-control" placeholder="{{$u->designation}}" value="{{$u->designation}}" name="designation">
                          </div>
                      </div>

                      <div class="form-group">
                          <label class="col-md-3 control-label" for="demo-text-input">Experience </label>
                          <div class="col-md-9">
                              <input type="number" id="demo-text-input" class="form-control" placeholder="{{$u->experience}}" value="{{$u->experience}}" name="experience">
                          </div>
                      </div>
