		    ...
		    <div class="col-sm-12">
		        <div class="panel">
		            <div class="panel-heading">
		                <h3 class="panel-title">Edit Course Here... </h3>
		            </div>
					@php
		            ...
		            <!--Horizontal Form-->
		            <!--===================================================-->
		            <form class="form-horizontal" method="post" action="{{route('courses.update',$courses->id)}}">
		            	@csrf
		            	@method('put')
		                <div class="panel-body">
		                    <div class="form-group">
	                           ...
	                           <div class="col-lg-9">
	                             <!-- Default choosen -->
	                              <!--===================================================-->
	                              <select data-placeholder="Select your department..." id="dept"  name="department_id" tabindex="2" class="form-control" value="{{$courses->department_id}}">
	                                <option value="{{$courses->department_id}}"> Select your Department... </option>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-sm-9">
		                            <input type="text" placeholder="Course Name" id="demo-hor-inputpass" class="form-control" name="course_name" value="{{ $courses->course_name }}"/>
		                        </div>
		                    </div>
		                    <div class="form-group">
	                           ...
	                           <div class="col-lg-9">
	                             <!-- Default choosen -->
	                              ...
	                              <select data-placeholder="Select your department..." id="course" name="staff_id" tabindex="2" class="form-control">
	                                <option value="{{ $courses->staff_id }}"> Select Tutor... </option>
