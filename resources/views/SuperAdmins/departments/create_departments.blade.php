					            ...
					            <form class="form-horizontal" method="post" action="{{route('departments.store')}}">
					                ...
					                <div class="panel-body">
					                    <div class="form-group">
					                        ...
					                        <div class="col-sm-9">
					                            <input type="text" placeholder="Department Full Name" id="demo-hor-inputemail" class="form-control" name="full_name">
					                        </div>
					                    </div>
					                    <div class="form-group">
					                        <label class="col-sm-3 control-label" for="demo-hor-inputpass">Department Short Name</label>
					                        <div class="col-sm-9">
					                            <input type="text" placeholder="Department Short Name" id="demo-hor-inputpass" class="form-control" name="short_name">
					                        </div>
					                    </div>
