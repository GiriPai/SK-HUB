		    ...
		    <div class="panel-body">
		        <table id="demo-foo-filtering" class="table table-bordered table-hover toggle-circle" data-page-size="7">
		            ...
		            <tbody>
		                ...
		                <tr>
		                    <td>{{ $staff->roll_no }}</td>
		                    <td><a href="{{ route('superadmin_view_staff',$staff->id) }}">{{ $staff->fname }}  {{ $staff->lname }}</a></td>
		                    ...
		                    <td><center>
			                    <div class="btn-group">
			                        <a href="{{ route('staff-management.show',$staff->id) }}"><button class="btn btn-default"><i class="demo-pli-exclamation"></i></button></a>
