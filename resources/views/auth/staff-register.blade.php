...
<body>
    <!-- <img src="{{ asset('/storage/profile/staff.jpg') }}" alt=""></img> -->
    					    ...
    					    <div class="eq-height clearfix">
    					        <div class="col-md-12 eq-box-md eq-no-panel">
    					            ...
    					            <div id="demo-main-wz">
    					                ...
    					                <!--form-->
    					                <form class="form-horizontal" method="post" action="{{ route('staff.register.submit') }}" enctype="multipart/form-data" >
                                  @csrf
                                  <div class="panel-body">
                                          ...
                                          <!-- <div class="form-group">
                                              ...
                                              <div class="col-lg-4">
                                                <input type="text" class="form-control" name="degree" placeholder="Email">

                                              </div>
                                              <label class="col-lg-2 control-label">Reg No</label>
                                              <div class="col-lg-4">
                                                  <input type="text" class="form-control" name="reg_no" placeholder="Email">
                                              </div>
                                          </div> -->
                                          ...
                                          <div class="form-group">
                                              ...
                                              <div class="col-lg-9 pad-no">
                                                  <div class="clearfix">
                                                      ...
                                                      <div class="col-lg-4 text-lg-right"><label class="control-label">Reg. No.</label></div>
                                                      <div class="col-lg-4">  <input type="text" class="form-control" name="reg_no" placeholder="Reg. No."></div>
                                                  </div>
                                              </div>
                                          </div>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-lg-9 pad-no">
                                                 <div class="clearfix">
                                                   ...
                                                   Browse... <input type="file" name="pic">
                                                     ...
                                                     <div class="col-lg-4 text-lg-right"><label class="control-label">Experience</label></div>
                                                     <div class="col-lg-4"><input type="number" placeholder="" name="exp" class="form-control"></div>
                                                 </div>
                                             </div>
                                         </div>
    					                    ...
    					                    <div class="pull-right pad-rgt mar-btm">
    					                        ...
    					                        <button type="submit" class="finish btn btn-success" name = "submit" disabled>Finish</button>
    					                    </div>
